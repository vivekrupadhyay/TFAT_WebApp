...
namespace TFATERPWebApplication.Core
{
    public static class CultureHelper
    {
        ...
        private static string[] _validCultures = ConfigurationManager.AppSettings["validCultures"].ToString().Split(',');
        private static string[] _cultures = ConfigurationManager.AppSettings["cultures"].ToString().Split(',');
