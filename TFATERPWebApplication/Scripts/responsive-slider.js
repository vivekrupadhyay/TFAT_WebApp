  ...
  (function($) {
    ...
    Slider.prototype = {
      ...
      prev: function(transitionTime, noanimation) {
        ...
        //$.fn.responsiveSlider.defaults.interval = 14000;
        //alert($.fn.responsiveSlider.defaults.interval+"");
    ...
    $.fn.responsiveSlider = function(option) {
      ...
      init = function($this) {
        ...
        $this.find('[data-jump]').on('click', function() {
            data[$(this).data('jump')]();
            //this.start();
            //clearTimeout($.fn.responsiveSlider.animations.slideAppearRightToLeft);
            //clearTimeout($.fn.responsiveSlider.animations.slideAppearLeftToRight);
