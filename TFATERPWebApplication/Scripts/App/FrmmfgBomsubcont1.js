$(document).ready(function () {
    ...
    $("#list6").jqGrid({
        ...
        type: 'POST',
        //mtype: 'GET',
        colNames: ["Sr.No.", "FormStore", "ToStore", "ProductCode", "ProductDescription", "Quantity","Qty-2", "Rate", "PerUnit", "RatePer", "Amount", "Narration"],
        colModel: [
            { name: "Sr.No.", index: 'Sr.No.', sortable: true, editable: true, editoptions: { readonly: false, size: 0 }, hidden: false, visible: true },//editoptions: { readonly: true, size: 0 }, hidden: false, visible: true
            ...
            { name: "Quantity", index: 'Quantity', align: "right", sortable: true, editable: true, edittype: 'text', editoptions: { size: 10 }, editrules: { required: true }, formoptions: { rowpos: 4, colpos: 3 } },
             { name: "Qty-2", index: 'Qty-2', align: "right", sortable: true, editable: true, edittype: 'text', editoptions: { size: 10 }, editrules: { required: true }, formoptions: { rowpos: 4, colpos: 3 } },
